...
export default function Tournaments() {
  ...
  const handleCreateTournament = async () => {
    ...
    const startDateTime = new Date(
      `${newTournament.date}T${newTournament.startTime}:00`
    );
    const endDateTime = new Date(
      `${newTournament.date}T${newTournament.endTime}:00`
    );
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Create and join ping pong tournaments.
          </p>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[500px] bg-[var(--background)]">
            <DialogHeader className="flex justify-center items-center flex-col">
              <DialogTitle>Create New Tournament</DialogTitle>
              <DialogDescription className="text-center">
                Set up a new ping pong tournament. The table will be reserved
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewTournament({
                      ...newTournament,
                      type: value as "singles" | "doubles",
                    })
                  }
                >
                  <SelectTrigger id="type" className="col-span-3 w-full">
            ...
            <div className="flex items-center justify-center">
              <DialogFooter>
                ...
                <Button className="w-[200px]" onClick={handleCreateTournament}>
                  Create
                </Button>
              </DialogFooter>
            </div>
              ...
              getUpcomingTournaments().map((tournament) => (
                <Card key={tournament.id}>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {tournament.type === "singles" ? "Singles" : "Doubles"}{" "}
                      Tournament
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span>
                          ...
                          {getMaxParticipants(tournament)} participants
                        </span>
                      </div>
                      <Separator />
                      <div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          toast(
                            "Tournament bracket view will be available in a future update",
                            {
